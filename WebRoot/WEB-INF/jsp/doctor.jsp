...
<body>
	...
	<table class="table table-bordered">
		...
		<c:forEach var="doctor" items="${doctorlist }">
			<tr style="text-align: center;">
				...
				<td>${doctor.occupation.occupationName }</td>
				<td>${doctor.doctorPassword }</td>
				...
				<td><input type="button" onclick="update(${doctor.doctorId})" value="修改" class="layui-btn"></td>
				<td><input type="button" onclick="dele(${doctor.doctorId})" value="删除" class="layui-btn"></td>
			</tr>
		</c:forEach>
	</table>
	...
	<script type="text/javascript">
		...
		function update(doctorId){
			location.href = "updatedoctor?doctorId=" + doctorId;
		}
		
		
		function Fuzzyquery(){
			var doctor_powerId = ${doctor_powerIdTow};
			var doctorName = $("#doctorName").val();
			var doctor_occupationId = $("#doctor_occupationId").val();
			location.href="FuzzyqueryDoctor?doctor_powerId=" + doctor_powerId + "&doctorName=" + doctorName + "&doctor_occupationId=" + doctor_occupationId;
		}
	</script>
