	...
	<form class="layui-form">
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="text" id="drugDetailsName" name="drugDetailsName" required  lay-verify="required" value="${drugdetails.drugDetailsName }" placeholder="请输入药品名称" autocomplete="off" class="layui-input">
		</div>
	 </div>
	  <div class="layui-form-item">
	    <label class="layui-form-label">药品描述</label>
	    <div class="layui-input-block">
	      <input type="text" id="drugDetailsDescribe" name="drugDetailsDescribe" required lay-verify="required" value="${drugdetails.drugDetailsDescribe }" placeholder="请输入药品描述" autocomplete="off" class="layui-input">
	   	</div>
	  </div>
	  <div class="layui-form-item">
	    <label class="layui-form-label">购买时间</label>
	    <div class="layui-input-block">
	      <input type="text" id="drugDetailsTime" name="drugDetailsTime" required  lay-verify="required" value='<fmt:formatDate value="${drugdetails.drugDetailsTime }" pattern="yyyy-MM-dd" />' placeholder="请输入购买时间" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      	<select id="drugDetails_DrugsId" name="drugDetails_DrugsId" >
	      		...
	      		<c:forEach var="durgs" items="${durgslist }">
	      			<option value="${durgs.drugsId }" ${durgs.drugsId  == drugdetails.drugDetails_DrugsId ? 'selected' :''} >${durgs.drugsName }</option>
	      		</c:forEach>
	      	</select>
	    </div>
	  </div>
...
<script type="text/javascript">
	function check() {
		...
		if (drugDetailsName == null || drugDetailsName == "") {
			...
			//ajax验证
			$.ajax({
				url : "updateDrugDetails",
				type : "post",
				data : {
					"drugDetailsId": ${drugdetails.drugDetailsId},	
